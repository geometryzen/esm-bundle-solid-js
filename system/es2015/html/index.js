 ...
 */
System.register(['../shared2.js', '../shared.js'], (function (exports) {
  'use strict';
  var style, insert, spread, delegateEvents, classList, dynamicProperty, setAttribute, setAttributeNS, addEventListener, Aliases, PropAliases, Properties, ChildProperties, DelegatedEvents, SVGElements, SVGNamespace, createRenderEffect, untrack, createComponent, mergeProps;
  return {
    setters: [function (module) {
      style = module.s;
      insert = module.i;
      spread = module.a;
      delegateEvents = module.d;
      classList = module.c;
      dynamicProperty = module.b;
      setAttribute = module.e;
      setAttributeNS = module.f;
      addEventListener = module.g;
      Aliases = module.A;
      PropAliases = module.P;
      Properties = module.h;
      ChildProperties = module.C;
      DelegatedEvents = module.D;
      SVGElements = module.S;
      SVGNamespace = module.j;
    }, function (module) {
      createRenderEffect = module.p;
      untrack = module.X;
      createComponent = module.i;
      mergeProps = module.J;
    }],
    execute: (function () {
      ...
      var html = exports('default', index);
