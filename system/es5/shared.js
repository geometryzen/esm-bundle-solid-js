  ...
  return {
    execute: (function () {
      ...
      exports({
        ...
        n: createMemo,
        o: createReaction,
        p: createRenderEffect,
        q: createResource,
        r: createRoot,
        s: createSelector,
        t: createSignal,
        u: createUniqueId,
        v: enableExternalSource,
        w: enableHydration,
        x: enableScheduling,
        z: from
      });
      ...
      const equalFn = exports('y', (a, b) => a === b);
      const $PROXY = exports('a', Symbol("solid-proxy"));
      const $TRACK = exports('b', Symbol("solid-track"));
      const $DEVCOMP = exports('$', Symbol("solid-dev-component"));
      const signalOptions = {
        equals: equalFn
      };
      let ERROR = null;
